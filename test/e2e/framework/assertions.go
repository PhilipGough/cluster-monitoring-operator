...
func (f *Framework) AssertThanosRulerIsCreated(name, namespace string) func(t *testing.T) {
	return func(t *testing.T) {
...
func (f *Framework) AssertPrometheusIsCreated(name, namespace string) func(t *testing.T) {
	return func(t *testing.T) {
...
func (f *Framework) AssertDeletionOfUserWorkloadAssets() func(*testing.T) {
	return func(t *testing.T) {
		f.TearDownUserWorkloadAssets(t)
